                    ...
                    <div class="card p-3">
                        <form method="post" action="{{ route('admin.categories.update', [$category]) }}">
                            ...
                            <div class="form-group row border-bottom pb-4">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="name" value="{{ old('name', $category->name) }}" id="name" placeholder="Ví dụ: Du lịch tham quan...">
                                </div>
                            </div>
                            <button type="submit" class="btn btn-success">Lưuu</button>
                        </form>
                    </div>
                </div>
            </div>
