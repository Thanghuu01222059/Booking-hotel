    ...
    <body>
        ...
        <header class="header" id="header">
            <nav class="nav container">
                <a href="{{ route('homepage') }}" class="nav__logo">G
                    <i class="bx bxs-map"></i> TRAVEL</a>
                <div class="nav__menu">
                    <ul class="nav__list">
                        <li class="nav__item">
                ...
                <a target="_blank" href="https://www.facebook.com/tuan.developer.fullstack" class="button nav__button">Booking Now</a>
            </nav>
        </header>
            ...
            <div class="footer__container container grid">
                <div>
                    ...
                    <p class="footer__description">
                        Tầm nhìn của chúng tôi là giúp mọi người tìm được <br />những địa điểm du lịch tốt nhất với mức độ bảo mật cao
                    </p>
                </div>
